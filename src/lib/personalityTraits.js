...
export const TRAIT_FAMILIES = [
  {
    ...
    traits: [
      { key: 'openness', label: 'Openness', low: 'Grounded', high: 'Curious', about: 'Appetite for new ideas, plans and perspectives.' },
      { key: 'conscientiousness', label: 'Conscientiousness', low: 'Spontaneous', high: 'Dependable', about: 'Follow-through — whether stated intentions become actions.' },
      { key: 'extraversion', label: 'Social Energy', low: 'Reserved', high: 'Outgoing', about: 'How much they initiate, expand and drive conversation.' },
      { key: 'agreeableness', label: 'Agreeableness', low: 'Blunt', high: 'Accommodating', about: 'Warmth and willingness to yield in friction.' },
      { key: 'emotionalStability', label: 'Emotional Steadiness', low: 'Reactive', high: 'Steady', about: 'How evenly they hold under stress. Framed positively on purpose.' },
    ],
  },
  {
    key: 'relational',
    ...
    traits: [
      { key: 'warmth', label: 'Warmth', low: 'Cool', high: 'Affectionate', about: 'How openly affection and appreciation get expressed.' },
      { key: 'directness', label: 'Directness', low: 'Hints', high: 'Says it plainly', about: 'Whether hard things are named or circled.' },
      { key: 'reassuranceNeed', label: 'Reassurance Need', low: 'Self-settling', high: 'Seeks closeness', about: 'How much comfort is sought when things feel uncertain.' },
      { key: 'conflictRepair', label: 'Repair Instinct', low: 'Withdraws', high: 'Moves toward', about: 'What they do after friction — reach out, or go quiet.' },
      { key: 'autonomy', label: 'Need for Space', low: 'Close-knit', high: 'Independent', about: 'How much separateness they need to feel comfortable.' },
    ],
  },
  {
    key: 'expressive',
    ...
    traits: [
      { key: 'humour', label: 'Humour', low: 'Earnest', high: 'Playful', about: 'How much play runs through the conversation.' },
      { key: 'curiosity', label: 'Curiosity About Others', low: 'Tells', high: 'Asks', about: 'Whether questions come back the other way.' },
      { key: 'vulnerability', label: 'Openness About Feelings', low: 'Guarded', high: 'Shares freely', about: 'Willingness to say what is actually going on inside.' },
      { key: 'responsiveness', label: 'Responsiveness', low: 'Takes time', high: 'Quick to reply', about: 'Attentiveness and pace of replying.' },
      { key: 'expressiveness', label: 'Expressiveness', low: 'Spare', high: 'Vivid', about: 'Emoji, emphasis and length — how much colour is used.' },
    ],
  },
];

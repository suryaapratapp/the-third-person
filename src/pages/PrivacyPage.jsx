...
const policySections = [
  ...
  ['Free-tier analysis processing', 'Your first two free Relationship Analyses are generated using a third-party AI processing service (Puter.com), called directly from your browser rather than through ThirdPerson AI\'s own servers. The same sensitive-detail protection is applied before this data is sent. Paid Relationship Reports, Guide Chats, and Personality Cards are generated only through ThirdPerson AI\'s own backend, which calls our AI provider server-side.'],

...
const SCENES = [
  {
    ...
    render: () => (
      <div className="grid gap-3">
        ...
        <div className="rounded-2xl border border-dashed border-line bg-well p-4">
  ...
  },
  {
    ...
    render: () => (
      <div className="relative grid gap-2.5">
        <div className="absolute bottom-4 left-[0.7rem] top-4 w-1 rounded-full bg-signal opacity-60" />
        {[
      ...
      <div className="relative">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="relative mx-auto w-full max-w-sm">
            <div className="rounded-sm border border-line bg-paper p-4 shadow-glow ">
              <div className="mb-3 flex items-center justify-between">
                <p className=" text-xs text-ash">ThirdPerson AI</p>
                <span className="flex gap-1">
                  {[0, 1, 2].map((dot) => <span key={dot} className="h-1.5 w-1.5 rounded-full bg-well" />)}
                </span>
              </div>

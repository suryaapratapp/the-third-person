...
export default function BestieBotSection() {
  ...
  const bullets = [
    ...
    'Keeps the tone honest, not delusional',
  ];
  ...
  return (
    <section className="relative overflow-hidden border-t border-white/10 px-4 py-20 sm:px-8">
      <div className="mx-auto grid max-w-[1320px] gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div>
          <p className="tech-label text-pink-200">Relationship Bestie</p>
          <h2 className="serif-title mt-4 text-5xl leading-tight sm:text-7xl">Meet your relationship Bestie.</h2>
          <p className="mt-6 max-w-2xl text-sm leading-8 text-smoke">
            A private AI bestie that understands your analysis chain and helps you talk through what happened, what changed, what went wrong, and what you can do next.
          </p>
        ...
        <div className="accent-panel rounded-[32px] p-5 sm:p-8">
          ...
          <p className="mx-auto max-w-2xl text-center text-sm leading-8 text-smoke">
            Ask anything about a relationship you’ve analysed — from “is he into me?” to “what should I reply?” ThirdPerson Bestie reads the full analysis chain and gives you honest, emotionally intelligent guidance.
          </p>

    ...
    <section className="mt-10" aria-label="What to do next">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-[28px] border border-pink-200/40 bg-gradient-to-br from-[#3a1730] via-[#2a1430] to-[#1d1228] p-6 text-left shadow-[0_18px_60px_rgba(255,120,170,0.16)] transition duration-200 hover:-translate-y-0.5 hover:border-pink-200/70 sm:p-7"
        >
          <div className="pointer-events-none absolute -right-10 -top-12 h-44 w-44 rounded-full bg-pink-400/25 blur-3xl transition group-hover:bg-pink-400/35" />
          <div className="relative flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <span className="mt-4 inline-flex items-center gap-2 rounded-full bg-pink-200/95 px-4 py-2 font-mono text-[0.66rem] uppercase tracking-[0.12em] text-[#3a1730]">
                Start chatting
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-[28px] border border-cyan-200/35 bg-gradient-to-br from-[#12243c] via-[#141a35] to-[#141229] p-6 text-left shadow-[0_18px_60px_rgba(120,200,255,0.14)] transition duration-200 hover:-translate-y-0.5 hover:border-cyan-200/60 sm:p-7"
        >
          <div className="pointer-events-none absolute -right-12 -top-14 h-48 w-48 rounded-full bg-cyan-400/20 blur-3xl transition group-hover:bg-cyan-400/30" />
          <div className="relative flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <span className="mt-4 inline-flex items-center gap-2 rounded-full bg-cyan-100/95 px-4 py-2 font-mono text-[0.66rem] uppercase tracking-[0.12em] text-[#12243c]">
                Open Know Yourself
                <PiArrowRight className="text-sm" aria-hidden="true" />
              </span>
            </div>
